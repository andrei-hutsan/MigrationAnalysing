namespace MigrationAnalysing.Models
{
    public class Table11
    {
        public int Id { get; set; }
        public string column49 { get; set; } = string.Empty;
        public string column48 { get; set; } = string.Empty;
        public string column47 { get; set; } = string.Empty;
        public string column46 { get; set; } = string.Empty;
        public string column45 { get; set; } = string.Empty;
        public string column44 { get; set; } = string.Empty;
        public string column43 { get; set; } = string.Empty;
        public string column42 { get; set; } = string.Empty;
        public string column41 { get; set; } = string.Empty;
        public string column40 { get; set; } = string.Empty;
        public string column39 { get; set; } = string.Empty;
        public string column38 { get; set; } = string.Empty;
        public string column37 { get; set; } = string.Empty;
        public string column36 { get; set; } = string.Empty;
        public string column35 { get; set; } = string.Empty;
        public string column34 { get; set; } = string.Empty;
        public string column33 { get; set; } = string.Empty;
        public string column32 { get; set; } = string.Empty;
